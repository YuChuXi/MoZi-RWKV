...
def get_tokenizer(tokenizer_name: str, n_vocab: int) -> Tuple[
    ...
    if tokenizer_name == 'world':
        prxxx('Loading World v20230424 tokenizer')
        return rwkv_world_tokenizer.get_world_tokenizer_v20230424()
    elif tokenizer_name == '20B':
        prxxx('Loading 20B tokenizer')
        import tokenizers
        tokenizer: tokenizers.Tokenizer = tokenizers.Tokenizer.from_file(str(parent / 'rwkv_cpp/20B_tokenizer.json'))
